...
public class CameraActivity extends Activity {
	...
	/**
	 * This method setup the camera.It calls a method from @CameraPreview and sets all camera parameters.
	 */
	...
	/**
	 * This method release the camera for other applications and set camera to null.
	 */
	...
	public Camera getCameraInstance() {
		...
		try {
			...
			Log.e(TAG, "failed to get an instance of camera");
			e.printStackTrace();
		}
