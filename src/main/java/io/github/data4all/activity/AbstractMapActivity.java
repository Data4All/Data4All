...
import io.github.data4all.model.map.MapLine; //NOSONAR
import io.github.data4all.model.map.MapMarker; //NOSONAR
import io.github.data4all.model.map.MapPolygon; //NOSONAR
 ...
 *
 */
public abstract class AbstractMapActivity extends BasicActivity { //NOSONAR
