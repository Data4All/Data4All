...
/**
 * the class SensorReactionActivity compute the reaction-time for sensors when a
 * user touching the screen or when he move the phone. then it get a Dialog,
...
public class SensorReactionActivity extends Activity implements
     ...
     * Logger Tag.
     */
    private static final String TAG = SensorReactionActivity.class
            .getSimpleName();
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if ((Float.compare(this.lastX, 0) == 0)
                && (Float.compare(this.lastY, 0) == 0)
