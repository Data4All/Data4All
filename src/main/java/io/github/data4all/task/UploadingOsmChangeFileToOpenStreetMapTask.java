...
public class UploadingOsmChangeFileToOpenStreetMapTask extends AsyncTask<Void, Void, Void> {
    ...
    public UploadingOsmChangeFileToOpenStreetMapTask(Context context, OAuthConsumer consumer,
           long id) {
