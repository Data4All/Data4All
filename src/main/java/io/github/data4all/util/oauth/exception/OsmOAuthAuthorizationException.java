...
/**
 * Indicates an failure in authorization progress.
 * 
 * @author tbrose (inspired by JOSM)
 */
public class OsmOAuthAuthorizationException extends Exception {
    private static final long serialVersionUID = -1500736234019230115L;
     ...
     *            indicates that the cause is nonexistent or unknown.)
     */
    public OsmOAuthAuthorizationException(String message, Throwable cause) {
        super(message, cause);
    }
}
