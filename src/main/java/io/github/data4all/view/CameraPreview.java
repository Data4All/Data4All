...
import io.github.data4all.util.CameraUtil;
...
public class CameraPreview extends ViewGroup implements SurfaceHolder.Callback {
	...
	private Size orientationPreviewSize;
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed && getChildCount() > 0) {
			...
			orientationPreviewSize = mCamera.new Size(previewHeight,
					previewHeight);

			if (mPreviewSize != null) {
				CameraUtil.getRotationAndSetPreviewSize(context, mPreviewSize,
						orientationPreviewSize);
			}
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
			if (mCamera != null) {
				...
				// set the picture size for the taking photo
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
		...
		mCamera.setDisplayOrientation(CameraUtil.getRotationAsInt(context));
