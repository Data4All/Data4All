...
public class TrackTest {
    ...
    public void testAddTrackPoint() {
        ...
        double expectedBLat = track.getLastTrackPoint().latitude;
        double expectedBLon = track.getLastTrackPoint().longitude;
        double expectedBAlt = track.getLastTrackPoint().altitude;
