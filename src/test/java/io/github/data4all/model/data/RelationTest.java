...
public class RelationTest {
	...
	/**
	 * Tests if getMember(OsmElement e) returns null, if the relationMember has no reference to an element.
	 */
	@Test
	...
	/**
	 * Tests if getMember(OsmElement e) return the correct relationMember containing the osm element.
	 */
	@Test
	...
	/**
	 * Test if getMember(String type, long id) returns the correct relation member.
	 */
	@Test
	...
	/**
	 * Test if getPosition() returns the correct position of the relation member. 
	 */
	@Test 
	public void test_getPosition() {
		RelationMember relationMemberWay = new RelationMember("way", 1, "");
		RelationMember relationMemberNode = new RelationMember("node", 2, "");
		RelationMember relationMemberRelation = new RelationMember("relation", 3, "");
		relation.addMember(relationMemberWay);
		relation.addMember(relationMemberNode);
	...
	/**
	 * Test if hasMember() returns true if the relation contains the relation member. 
	 */
	@Test 
	...
	/**
	 * Test if appendMember() can append a new relation member at the begin or the end of the list.
	 */
	@Test 
	...
	/**
	 * Test if addMemberAfter() adds a new relation member behind a reference member.
	 */
	@Test 
	 ...
	 * Test if all relation member have the correct position. 
	 */
	@Test 
	...
	/**
	 * Tests the addMembers() method. 
	 * Adds a list of relation member to the relation at the beginning.
	 * Checks the correct position of the members. 
	 */
	@Test 
	...
	/**
	 * Tests the getMemberWithRole() method. 
	 * Check if the result list contains the correct relation members. 
	 */
	@Test 
	public void test_getMembersWithRole() {
		...
		RelationMember relationMember3 = new RelationMember("relation", 6, "test");
		relation.addMember(relationMember1);
		relation.addMember(relationMember2);
		relation.addMember(relationMember3);
	...
	/**
	 * Replaces a member in the list.
	 * Tests if the new member is in the list and at the correct position.
	 */
	@Test 
	...
	/**
	 * Test if the result list contains all relation member with a reference to an osm object.
	 */
	@Test 
