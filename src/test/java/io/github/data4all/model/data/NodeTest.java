...
/**
 * Testing the main functionality of the node objects.
 * Testing inherited methods from OsmElement class. 
 * @author fkirchge
 *
 */
public class NodeTest {
	...
	/**
	 * Tests if the setTags() methods works correctly.
	 * Add tags, check if tags are stored, replace all existing tags with newTags
	 * and check again if they are stored.
	 */
	@Test
	...
	/**
	 * Adds a new tag using the addOrUpdateTag() method.
	 * Replacing existing tag with new value.
	 * Test if they are stored correctly.
	 */
	@Test
	...
	/**
	 * Adding a list of tags using the addTag() method.
	 * Tests if all tags are stored correctly.
	 */
	@Test
	...
	/**
	 * Tests if the relation is contained in the list of parent relations.
	 * Using the relation as identifier.
	 */
	@Test
	...
	/**
	 * Test if the relation is contained in the list of parent relations.
	 * Using the osmId as identifier.
	 * 
	 */
	@Test
	...
	/**
	 * Adds a list of relations to as parent relations of the node.
	 * Tests if all list elements are stored. 
	 */
	@Test
	...
	/**
	 * Tests if parent relations can be removed from the list by relation identifier. 
	 */
	@Test
	...
	/**
	 * Tests if parent relations can be removed from the list by osmId as identifier.  
	 */
	@Test
