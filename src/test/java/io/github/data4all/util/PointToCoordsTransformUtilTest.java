...
public class PointToCoordsTransformUtilTest {
    ...
    /*
     * @Test public void transformTest(){ location.setLatitude(0.0);
     * location.setLongitude(0.0); TransformationParamBean tps = new
     * TransformationParamBean(2.0, Math.toRadians(45) , Math.toRadians(45) ,
     * 1000, 1000, location); DeviceOrientation deviceOrientation = new
     * DeviceOrientation(0.0f, 0.0f, 0.0f, 10L); ArrayList<Point> points = new
     * ArrayList<Point>(); points.add(new Point(500, 500)); points.add(new
     * Point(1000, 500)); points.add(new Point(500, 1000)); points.add(new
     * Point(1 , 500)); points.add(new Point(500,1)); List<Node> test =
     * util.transform(tps, deviceOrientation, points);
     ...
     * 0.0f, 10L); test = util.transform(tps, deviceOrientation, points);
     * assertThat(test.get(0).getLat(), is(0.0));
     * assertThat(test.get(0).getLon(), is(0.0));
